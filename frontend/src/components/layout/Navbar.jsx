...
import { Menu, X, Cpu, Network, Boxes, Trophy, Library, Zap, Wallet } from "lucide-react";
...
const LINKS = [
  ...
  { to: "/kernel-bypass", label: "Kernel Bypass", icon: Zap, color: "#ef4444" },
  { to: "/finance", label: "Finance", icon: Wallet, color: "#14b8a6" },
  { to: "/library", label: "Library", icon: Library, color: "#06b6d4" },
];
